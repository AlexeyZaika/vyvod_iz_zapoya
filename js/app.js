...
function initSlider() {
	...
	let sliderWrap = document.querySelector(".feedback__wrapper");
  let slides = document.querySelectorAll(".feedback__item");
  let sliderArrow = document.querySelector(".feedback__button-next");
  ...
  function moveSlider(num) {
    let height = sliderWrap.querySelector(".n" + num).offsetHeight;
    sliderWrap.querySelector(".active").classList.remove("active");
    sliderWrap.querySelector(".n" + num).classList.add("active");
...
document.addEventListener("DOMContentLoaded", function() {
  initSlider();
  let sliderWrap = document.querySelector(".feedback__wrapper");
  let heightStart = sliderWrap.querySelector(".active").offsetHeight;
  sliderWrap.style.height = heightStart + 'px';
});
